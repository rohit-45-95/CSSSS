...
- CS Launcher is a Minecraft launcher by Craft Studio Team. Its full name is Craft Studio Launcher, and it is designed to run [Minecraft: Java Edition](https://www.minecraft.net/) on Android devices.
- CS Launcher aims to enhance user experience with a polished UI, stronger Android compatibility, and deeper renderer support so more players can enjoy Minecraft smoothly.
...
- CS Launcher is open source under the GPL v3 license.
...
#### Additional Code Libraries Used by Craft Studio Launcher
